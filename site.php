...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="folder-css/botstrap.min.css" />
		<link rel="stylesheet" href="folder-css/bootstrap.min.css.map" />
		<link rel="stylesheet" href="folder-css/button-3.css" />
		<link rel="stylesheet" href="folder-css/icons.css" />
		<link rel="stylesheet" href="folder-css/slick.css" />
		<link rel="stylesheet" href="folder-css/animate.min.css" />
		<link rel="stylesheet" href="folder-css/slick-theme.css" />
		...
		<script src="folder-js/jquery.file.min.js"></script>
		<link href="https://fonts.googleapis.com/css2?family=Oswald:wght@200;300;400;500;600;700&display=swap" rel="stylesheet" />
		<link href="https://fonts.googleapis.com/css2?family=Dancing+Script:wght@400;500;600;700&display=swap" rel="stylesheet" />
		<script src="folder-js/jquery.cookie.file.js"></script>
		<style>
			          body{
			              direction: ltr;
			          ...
			          margin-left: auto;
			          margin-right: auto;
			          background-image:linear-gradient( to right, rgba(47, 48, 58, 0.5), rgba(47, 48, 58, 0.5) ), url(0_bg.jpg);
  ...
  @media (min-width: 1400px){
      .pricing_shell_MCr{
          max-width: 1292px;
					...
					.section-partner{
						position: relative;
						background-image: linear-gradient(to right, rgba(47,48,58,0.8), rgba(47,48,58,0.8)), url(1_bg.jpg);
						background-size: cover;
						background-position: center;
						background-repeat: no-repeat;
	...
	<div class="container">
		<ul class="slider-partners">
			<li class="partner-block">
				<img src="0_part.png" alt="" />
			</li>
			<li class="partner-block">
				<img src="1_part.png" alt="" />
			</li>
			<li class="partner-block">
				<img src="2_part.png" alt="" />
			</li>
			<li class="partner-block">
				<img src="3_part.png" alt="" />
			</li>
			<li class="partner-block">
				<img src="4_part.png" alt="" />
			</li>

			<li class="partner-block">
				<img src="5_part.png" alt="" />
			</li>
		</ul>
	</div>
</section>
		...
		<div class="service-wrapper">
						<div class="row service-box">
							<div class="col-12 col-lg-6">
								<img class="rot" src="0_vectimg.svg"  alt="" />
							</div>
						...
						<div class="row service-box">
							...
							<div class="col-12 col-lg-6 mt-3 mt-lg-0">
								<img class="rot" src="1_vectimg.svg" alt="" />
							</div>
						</div>
					</div>
	</div>
...
<footer class="footer header">
	<div class="container">
		...
		<script type="text/javascript" src="folder-js/wow.min.js"></script>
		<script type="text/javascript" src="folder-js/bootstrap.min.js"></script>
		<script type="text/javascript" src="folder-js/slick.min.js"></script>	
		<script>
